...
rr = StochasticApproximation(params, 1, false, 1, 1, false, false,0.2,0.15); %a,c要改
% penultimate parameter is stepsize a0, last parameter is c

dev_DCS = rr.abs_err*100;  %threshold estimation deviation record for 30 steps (in %MSO)
