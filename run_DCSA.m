...
rr = StochasticApproximation(params, 3, false, 1, 1, false, false,0.15,0.15); %a,c要改
% penultimate parameter is stepsize a0, last parameter is c

dev_DCSA = rr.abs_err*100;  %threshold estimation deviation record for 30 steps (in %MSO)
