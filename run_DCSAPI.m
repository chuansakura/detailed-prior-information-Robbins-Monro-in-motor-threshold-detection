...
rr = StochasticApproximation(params, 39, false, 1, 1, false, false,0.15,0.15);
% penultimate parameter is stepsize a0, last parameter is c

dev_DCSAPI = rr.abs_err*100;  %threshold estimation deviation record for 30 steps (in %MSO)
